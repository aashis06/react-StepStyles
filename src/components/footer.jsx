        ...
        <footer className="bg-gray-900 text-white py-12">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-400 mb-6 max-w-md">
                            We make shoes designed for comfort and everyday style. Step into quality, comfort, and style with our premium collection.
                        </p>
                        <div className="flex space-x-4">
                            <a href="#" className="bg-gray-800 hover:bg-gray-700 p-2 rounded-full transition-colors duration-300">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><Link to="/shipping" className="text-gray-400 hover:text-white transition-colors duration-300">Shipping Info</Link></li>
                            <li><Link to="/returns" className="text-gray-400 hover:text-white transition-colors duration-300">Returns</Link></li>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex w-full md:w-auto">
                            ...
                            />
                            <button className="px-6 py-2 bg-blue-500 hover:bg-blue-600 text-white rounded-r-lg transition-colors duration-300 cursor-pointer">
                                Subscribe
                            </button>
                        </div>
                    </div>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 text-center">
                    <p className="text-gray-400">© 2025 StepStyle. All rights reserved. | Privacy Policy | Terms of Service</p>
                </div>
            </div>
        </footer>
    );
